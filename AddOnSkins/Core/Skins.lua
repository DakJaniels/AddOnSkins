...
S.TBC = WOW_PROJECT_ID == WOW_PROJECT_BURNING_CRUSADE_CLASSIC -- not used
S.Cata = WOW_PROJECT_ID == WOW_PROJECT_CATACLYSM_CLASSIC
S.Wrath = WOW_PROJECT_ID == WOW_PROJECT_WRATH_CLASSIC
S.Mists = WOW_PROJECT_ID == WOW_PROJECT_MISTS_CLASSIC
